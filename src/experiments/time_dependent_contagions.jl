...
"""
    Experiment of section 5.4 of the paper
"""
...
fparams = "src/experiments/configs/54/aamas54.csv"
...
output_path = "src/experiments/results/54/csv"
...
for testtype in keys(test_data)
    ...
    savefig("src/experiments/results/54/plot/$(mytitle).png")
end
